...
collar plots latex:
  ...
  collect files:
    specs_collar_demo.yaml: factory/calc/collar_demo/calcs/specs/collar_demo.yaml
    art_collar.py: factory/calc/collar_demo/calcs/art_collar.py
    matplotlibrc_custom: factory/matplotlibrc
  script: |
    cd factory/calc/collar_demo
    make set mpl_agg=True
    make set usetex=True
    make set matplotlibrc=~/factory/matplotlibrc
    #make plot undulations plot_height_profiles
    #make plot undulations undulation_spectra
    make plot lipid_mesh plot_curvature_maps
    #make plot curvature_undulation_coupling individual_reviews
...
demo dev serve:
  ...
  collect files: 
    ...
    specs_demo_dev.yaml: specs_demo_dev.yaml
  script: |
    cd factory
    source /usr/local/gromacs/bin/GMXRC.bash
    make set automacs_branch dev
    make connect demo_dev public
    # why is this broken? on the second start?
    #mv ~/specs_demo_dev.yaml ~/factory/calc/demo_coarse/calcs/specs/specs_demo_dev.yaml
